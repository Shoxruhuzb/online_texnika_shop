...
from django.views.generic import DetailView, TemplateView, ListView, FormView, CreateView

from apps.forms import LoginForm, RegisterForm
from apps.mixins import LoginNotRequiredMixin
from apps.models import Product, CartItem, User
...
class LoginFormView(LoginNotRequiredMixin, FormView):
    ...
    def form_invalid(self, form):
        messages.error(self.request, "Bunday foydalanuvchi mavjud emas.")
...
class CartListView(LoginRequiredMixin, ListView):
    ...
    template_name = 'apps/products/cart.html'
